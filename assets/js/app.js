...
function onScroll() {
    ...
    $("#menu li a").each(function() {
        ...
        , i = $(o.attr("href"));
        if (i.length > 0) {
            i.position().top <= e + 64 && i.position().top + i.height() > e - 128 ? ($("#menu li a").removeClass("active"),
            o.addClass("active")) : o.removeClass("active")
        }
    })
}
var num = 50;
...
$(document).ready(function() {
    $(".fancybox").fancybox({
        beforeLoad: function() {
            $(".modal").addClass("fancybox-lock");
        },
        afterClose: function() {
            $(".modal").removeClass("fancybox-lock");
        },
        helpers: {
            title: {
                type: 'inside'
